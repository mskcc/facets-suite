...
main = function(maf, cncf_files){
  ...
  maf[,purity := as.numeric(purity)]
  maf[,ploidy := as.numeric(ploidy)]
  maf[,dipLogR := as.numeric(dipLogR)]
  maf[,loglik := as.numeric(loglik)]
