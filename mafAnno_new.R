...
integer_cn_table = function(out, fit){
...
maf[,c("ccf_Mcopies_em", "ccf_Mcopies_lower_em", "ccf_Mcopies_upper_em", "ccf_Mcopies_prob95_em", "ccf_Mcopies_prob90_em"):=ccf.likelihood(purity,
                                                                                                                    ...
                                                                                                                    t_alt_count,
                                                                                                                    (t_alt_count + t_ref_count),
                                                                                                                    copies=(tcn.em-lcn.em)), by= 1:nrow(maf)]

  maf[,c("ccf_1copy_em", "ccf_1copy_lower_em", "ccf_1copy_upper_em", "ccf_1copy_prob95_em", "ccf_1copy_prob90_em"):=ccf.likelihood(purity,
                                                                                                                    tcn.em,
                                                                                                                    t_alt_count,
                                                                                                                    (t_alt_count + t_ref_count),
                                                                                                                    copies=1), by= 1:nrow(maf)]
